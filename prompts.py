...
- 準備
  ...
  - 案件の「作業場所」から「都道府県」を類推してください。ただし、大都市圏の場合は以下のルールに従うこと
    - 東京都、神奈川県、埼玉県、千葉県は「関東圏」として一つの地域とみなす
    - 大阪府、兵庫県、京都府は「関西圏」として一つの地域とみなす
  - 要員の都道府県については案件と同じく最寄駅から類推する、類推できない場合は「不明」とする

- 各要員情報を走査し、案件の勤務形態と要員の希望勤務形態が合わない候補を除外する
  - 案件が「常駐」または「リモート併用」または「ハイブリッド」のいずれかの場合、案件の「都道府県」または「⚪︎⚪︎圏」がマッチしない要員を除外する
  - 案件が「フルリモート」の場合、要員を除外する必要はない

### STEP 2: 総合（スキル）マッチング

- スキルや希望勤務形態、備考に書かれている事項などに基づき、総合的に判定する
